...
ckpt_path=/valleblob/v-wenxichen/exp/s2s-interleave/gpu4-btz6-lr1e-5-SLAM-Omni_fine-tuning-distill_emotion_alpaca/gpu4-btz6-lr1e-5-SLAM-Omni_fine-tuning-distill_emotion_alpaca-s2s_epoch_3_step_508
...
online_output_dir=/home/wenxi/mydisk/exp/conversation/gpu4-btz6-lr1e-5-SLAM-Omni_fine-tuning-distill_emotion_alpaca
