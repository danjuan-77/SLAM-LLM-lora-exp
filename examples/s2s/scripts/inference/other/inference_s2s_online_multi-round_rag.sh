...
vector_store_path=/home/wenxi/langchain_test/slam_omni_rag_faiss_local_medical
...
multi_round=true
online_output_dir=/home/wenxi/mydisk/exp/conversation/multi-round-zh-rag
...
python $code_dir/inference_s2s.py \
        ...
        ++decode_config.use_rag=$use_rag \
        ++decode_config.rag_config.framework=$framework \
        ++decode_config.rag_config.vector_store_type=$vector_store_type \
        ++decode_config.rag_config.vector_store_path=$vector_store_path \
        ++decode_config.rag_config.embedding_model_name=$embedding_model_name \
        ++decode_config.rag_config.top_k=$top_k \
...
# bash ./examples/s2s/scripts/inference/other/inference_s2s_online_multi-round_rag.sh