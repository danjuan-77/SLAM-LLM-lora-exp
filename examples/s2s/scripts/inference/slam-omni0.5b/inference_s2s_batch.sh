...
ckpt_path=/mnt/buffer/tuwenming/checkpoints/slam-omni/wenxi/Qwen2-0.5b-whisper_small-latency0-group3-single-round-English
# jsonl dataset
...
# bash ./examples/s2s/scripts/inference/slam-omni0.5b/inference_s2s_batch.sh