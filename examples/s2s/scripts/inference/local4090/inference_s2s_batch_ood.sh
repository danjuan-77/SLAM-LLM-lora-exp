...
speech_encoder_path="/home/tuwenming/Models/openai/whisper/${whisper_size}.pt"   # replace this with your own whisper model path (different whisper size)
llm_path="/home/tuwenming/Models/Qwen/Qwen2-0.5B"
codec_decoder_path="/home/tuwenming/Models/FunAudioLLM/CosyVoice-300M-SFT" # replace this with your own CosyVoice model path
...
ckpt_path=/home/tuwenming/Projects/UltraVoice_dev/eval/slam-omni-sft-ckpt/s2s_epoch_3_step_306/
# jsonl dataset
...
val_data_path="/home/tuwenming/Projects/UltraVoice_dev/data/slam_omni_parquet/ood"
...
audio_prompt_path=/home/tuwenming/Projects/UltraVoice_dev/data/spk_voice/alloy.wav       # replace this with your own audio prompt path or our provided audio prompt path
...
# nohup bash ./examples/s2s/scripts/inference/slam-omni0.5b/inference_s2s_batch_volume.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_gpu1_$(date +%Y%m%d%H%M%S).log 2>&1 &

# nohup bash ./examples/s2s/scripts/inference/slam-omni0.5b/inference_s2s_batch_volume.sh > /share/nlp/kangyipeng/logs/run_task_slamomni_inference_gpu1_$(date +%Y%m%d%H%M%S).log 2>&1 &
