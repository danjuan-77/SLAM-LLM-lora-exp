...
train_data_path=/share/nlp/tuwenming/datasets/ultravoice160k/gqa_volume # train data & validation data
val_data_path=/share/nlp/tuwenming/datasets/ultravoice160k/gqa_volume
...
# bash examples/s2s/scripts/finetune/slam-omni3b/finetune_s2s_interleave_lora_ultravoice_sft_gqa_volume_lr5.sh