...
train_data_path=/share/nlp/tuwenming/datasets/ultravoice160k/gqa_emotion # train data & validation data
val_data_path=/share/nlp/tuwenming/datasets/ultravoice160k/gqa_emotion
...
# bash examples/s2s/scripts/finetune/slam-omni3b/finetune_s2s_interleave_lora_ultravoice_sft_gqa_emotion_lr4.sh