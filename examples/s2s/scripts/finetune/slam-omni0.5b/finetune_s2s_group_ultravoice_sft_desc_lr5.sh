...
# dataset settings
dataset_name=description_without_gqa
manifest_format=parquet             # parquet or jsonl
train_data_path="/share/nlp/tuwenming/datasets/ultravoice100k/train_without_gqa/${dataset_name}" # train data & validation data
val_data_path="/share/nlp/tuwenming/datasets/ultravoice100k/train_without_gqa/${dataset_name}"
