...
train_data_path="/share/nlp/tuwenming/datasets/ultravoice100k_clean/train_without_gqa/${dataset_name}" # train data & validation data
val_data_path="/share/nlp/tuwenming/datasets/ultravoice100k_clean/train_without_gqa/${dataset_name}"
