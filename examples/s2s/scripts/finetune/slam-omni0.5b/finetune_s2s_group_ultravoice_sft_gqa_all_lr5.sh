...
# nohup bash examples/s2s/scripts/finetune/slam-omni0.5b/finetune_s2s_group_ultravoice_sft_gqa_all_lr5.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_sft_gqa_all_lr5_$(date +%Y%m%d%H%M%S).log 2>&1 &