...
if __name__ == "__main__":
    # Example usage
    add_labels_to_jsonl(
        input_path="/home/wenxi/LLaMA-Factory/saves/Qwen2.5-7B-Instruct/freeze/trivia_qa/generated_predictions.jsonl",
        output_path="/home/wenxi/LLaMA-Factory/saves/Qwen2.5-7B-Instruct/freeze/trivia_qa/test.jsonl",
