...
# nohup bash ./scripts/inference_s2s_epoch_1_step_1000_emotion.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_1_step_1000_emotion_gpu3_$(date +%Y%m%d%H%M%S).log 2>&1 &
