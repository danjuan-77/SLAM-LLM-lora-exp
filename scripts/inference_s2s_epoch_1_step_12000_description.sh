...
ckpt_path=/mnt/buffer/tuwenming/checkpoints/slam-omni/gpu4-btz1-lr1e-5-warmup_steps5000-SLAM-Omni-fine-tuning-dataset-ultravoice100k-train_all/s2s_epoch_1_step_12000
...
# nohup bash ./scripts/inference_s2s_epoch_1_step_12000_description.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_1_step_12000_description_gpu2_$(date +%Y%m%d%H%M%S).log 2>&1 &
