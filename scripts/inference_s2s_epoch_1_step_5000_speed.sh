...
# nohup bash ./scripts/inference_s2s_epoch_1_step_5000_speed.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_1_step_5000_speed_gpu2_$(date +%Y%m%d%H%M%S).log 2>&1 &
