...
# nohup bash ./scripts/inference_s2s_epoch_2_step_20096_speed.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_2_step_20096_speed_gpu0_$(date +%Y%m%d%H%M%S).log 2>&1 &
