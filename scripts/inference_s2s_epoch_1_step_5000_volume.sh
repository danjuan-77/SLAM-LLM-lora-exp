...
# nohup bash ./scripts/inference_s2s_epoch_1_step_5000_volume.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_1_step_5000_volume_gpu3_$(date +%Y%m%d%H%M%S).log 2>&1 &
