...
# nohup bash ./scripts/inference_s2s_epoch_2_step_15096_volume.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_2_step_15096_volume_gpu3_$(date +%Y%m%d%H%M%S).log 2>&1 &
