...
# nohup bash ./scripts/inference_s2s_epoch_1_step_10000_volume.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/run_task_slamomni_inference_s2s_epoch_1_step_10000_volume_gpu1_$(date +%Y%m%d%H%M%S).log 2>&1 &
